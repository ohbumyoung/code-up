...
import com.kh.B_CheckedExceptoin;
import com.kh.MyException;
public class Run {
	/*
	 *에러 종류
	 -시스템 에러: 컴퓨터 오작동으로 발생하여, 소스코드로 해결 불가한 에러(코드로 처리불가, 심각한 에러)
	 ...
	 => 시스템 에러를 제외한 나머지 에러들은 개발자가 처리할 수 있는 예외에 해당
	...
	*예외 처리 방법
	...
	public static void main(String[] args) {
		...
		B_CheckedExceptoin b = new B_CheckedExceptoin();
		//b.test1();
		try {
		b.test2();
		} catch(IOException e) {
	...
	public static void method1() throws MyException{
		...
		// 예외 발생시키기 => throw
		throw new MyException("metho1 내가 만든 예외 발생 시킴");
	}
